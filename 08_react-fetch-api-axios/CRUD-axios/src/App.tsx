...
function App() {
	...
	//penulisan asycn await pada arrow function
	...
	useEffect(() => {
		...
		const response = axios.get('https://660faaa8356b87a55c51fa80.mockapi.io/users');
		console.log(response); // pending karena, data belum datang tapi kita sudah coba untuk tampilkan pada layar
		fetchData();
